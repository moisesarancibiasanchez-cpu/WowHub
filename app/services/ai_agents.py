...
_GLOBAL_RULES = (
    ...
    "    f) Las features en ROADMAP (loyalty, pedidos, integraciones, "
    "delivery, POS avanzado, whatsapp templates) NO están desplegadas en "
    "producción. NO generes URLs para ellas. NO des walkthroughs, "
    "NO listes pasos, NO inventes nombres de tools (ej. "
    "'add_loyalty_stamp', 'redeem_reward', 'send_whatsapp_template', etc.) "
    ...
    "    IMPORTANTE (v1.9.1-r7): RESERVAS SÍ está desplegado en producción. "
    "Los tools `check_availability`, `create_booking` y `list_bookings` "
    "EXISTEN y están disponibles para los agentes marketing/growth/"
    "automation. Si el usuario pregunta cómo crear una reserva, puedes "
    "darle un walkthrough real usando esos tools. NO trates reservas "
    "como feature de roadmap.\n"
